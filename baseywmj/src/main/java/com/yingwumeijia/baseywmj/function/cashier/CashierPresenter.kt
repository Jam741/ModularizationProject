...
import com.yingwumeijia.baseywmj.function.paysdk.alipay.AliPaySDK
import com.yingwumeijia.baseywmj.function.paysdk.alipay.PayResult
import com.yingwumeijia.baseywmj.function.paysdk.wxpay.WXPaySDK
...
//            msg = "用户取消了支付"
    ...
    override fun registerWXPay() {
        //注册微信支付广播
        val intentFilter = IntentFilter(Constant.WX_PAY_BORAD_COST_ACTION)
